...
#cunderlik-gallery-modal .cunderlik-modal-frame{position:relative;width:min(820px,88vw);aspect-ratio:16/9;border-radius:18px;overflow:hidden;background:#111;border:3px solid #fff;box-shadow:0 24px 70px rgba(0,0,0,.48)}\
...
@media(max-width:640px){.window-honda .cunderlik-gallery-photo{left:10px;top:10px;width:96px;height:72px;border-radius:10px}#cunderlik-gallery-modal{padding:14px}#cunderlik-gallery-modal .cunderlik-modal-frame{width:94vw;border-radius:14px}}';
